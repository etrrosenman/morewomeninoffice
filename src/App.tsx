...
function RaceTable({ rows, office }: { rows: RaceRow[], office: Office }) {
  ...
  return <section className="races">
    {office === 'senate' && <aside className="senate-baseline-note"><strong>Note:</strong> Incumbent senators Marsha Blackburn (R–TN) and Amy Klobuchar (D–MN) are each running for governor in their respective states. As both are favored to win, they are likely to leave the Senate next year. Nonetheless, they are included in the current baseline count.</aside>}
